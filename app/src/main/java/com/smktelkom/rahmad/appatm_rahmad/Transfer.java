...
public class Transfer extends CekSaldo {
    Button btn1, btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9,btn0,btnok,btndel;

    EditText edittarik,editsaldo,edittransfer,editRek;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editRek = (EditText)findViewById(R.id.editRek);
    ...
    private void isi(int uang) {
        ...
        String rek = editRek.getText().toString();
        int x = tab-h1;

        edittransfer.setText("Anda Berhasil Transfer Ke "+ rek +", Sisa Saldo Anda " + String.valueOf(x));
